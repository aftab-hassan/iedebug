...
import { TextField, Toggle, DetailsList, DetailsListLayoutMode, Selection, SelectionMode, IColumn, MarqueeSelection, mergeStyleSets, Fabric } from 'office-ui-fabric-react';
